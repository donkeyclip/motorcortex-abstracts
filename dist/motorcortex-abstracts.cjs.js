...
var uncurryThis$d = bind$2 && bind$2.bind(call$3, call$3);
...
var v8PrototypeDefineBug = DESCRIPTORS$3 && fails$6(function () {
  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var CrossMoveRight = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(CrossMoveRight, [{
    ...
    value: function buildTree() {
      for (var i = 1; i <= this.attrs.items; i++) {
        var crossScale = new motorcortex.CSSEffect({
          animatedAttrs: {
            transform: {
              scale: 1,
        ...
        var crossLeft = new motorcortex.CSSEffect({
          animatedAttrs: {
...
var CrossMoveRightOutline = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(CrossMoveRightOutline, [{
    ...
    value: function buildTree() {
      for (var i = 0; i <= this.attrs.steps; i++) {
        var crossOpacityOn = new motorcortex.CSSEffect({
          animatedAttrs: {
            opacity: 1
          },
          initialValues: {
        ...
        var crossOpacityOff = new motorcortex.CSSEffect({
          animatedAttrs: {
            opacity: 0
          },
          initialValues: {
...
var VerticalLinesMove = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(VerticalLinesMove, [{
    ...
    value: function buildTree() {
      for (var i = 0; i <= 3; i++) {
        var lineTop = new motorcortex.CSSEffect({
          animatedAttrs: {
        ...
        var lineHeigth = new motorcortex.CSSEffect({
          animatedAttrs: {
            height: "0px"
          }
        }, {
...
var CircleExplosion = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(CircleExplosion, [{
    ...
    value: function buildTree() {
      for (var i = 0; i < this.attrs.items; i++) {
        var circleTop = new motorcortex.CSSEffect({
          animatedAttrs: {
            transform: {
        ...
        var circleWidthUp = new motorcortex.CSSEffect({
          animatedAttrs: {
        ...
        var circleWidthDown = new motorcortex.CSSEffect({
          animatedAttrs: {
...
var Dots = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(Dots, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var dotsOpacity = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
  ...
  _createClass(CrossRowReveal, [{
    ...
    value: function buildTree() {
      for (var i = 0; i < this.attrs.items; i++) {
        ...
        var reveal = new motorcortex.CSSEffect({
          animatedAttrs: {
            opacity: 1
          },
          initialValues: {
      ...
      var crossTop = new motorcortex.CSSEffect({
        animatedAttrs: {
          top: "0px"
        }
      }, {
