...
class CrossMoveRight extends motorcortex.HTMLClip {
  get font() {
    return [{
      type: "google-font",
  ...
  buildTree() {
    for (let i = 1; i <= this.attrs.items; i++) {
      ...
      const crossLeft = new motorcortex.CSSEffect({
        animatedAttrs: {
...
class CrossMoveRightOutline extends motorcortex.HTMLClip {
  ...
  buildTree() {
    for (let i = 0; i <= this.attrs.steps; i++) {
      ...
      const crossOpacityOff = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
...
class VerticalLinesMove extends motorcortex.HTMLClip {
  ...
  buildTree() {
    for (let i = 0; i <= 3; i++) {
      ...
      const lineHeigth = new motorcortex.CSSEffect({
        animatedAttrs: {
          height: "0px"
        }
      }, {
...
class CircleExplosion extends motorcortex.HTMLClip {
  ...
  buildTree() {
    for (let i = 0; i < this.attrs.items; i++) {
      ...
      const circleWidthUp = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      const circleWidthDown = new motorcortex.CSSEffect({
        animatedAttrs: {
...
class CrossRowReveal extends motorcortex.HTMLClip {
  ...
  buildTree() {
    for (let i = 0; i < this.attrs.items; i++) {
      ...
      const reveal = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
